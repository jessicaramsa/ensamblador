...
menu db "Teclea la opcion que deceas realizar:",0dh,0ah,0dh,0ah,"1.- Suma",0dh,0ah,"2.-Resta",0dh,0ah,"3.- Multiplicacion","$"
...
suma:	mov bh,70h	;fondo blanco frente negro
	call Color
	call operacionSuma
	jmp fin

resta:  mov bh,70h	;fondo blanco frente negro
	call Color
	call operacionResta
	jmp fin

multiplicacion: mov bh,70h	;fondo blanco frente negro
	call Color
	call operacionMult
	jmp fin
